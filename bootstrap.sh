...
cd dotfiles-master
for file in {aliases,bash_profile,bash_prompt,bashrc,curlrc,exports,functions,gemrc,gitconfig,hushlogin,inputrc,irbrc,path,pryrc,rspec,screenrc,wgetrc}; do
  cp -f ."$file" ~/."$file";
done;
unset file;
